...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'BOURBON'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'BOURBON' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          removed={removed}
          bscScanAddress={`https://explorer.dogechain.dog/address/${farm.lpAddresses[process.env.REACT_APP_CHAIN_ID]}`}
